...
// 2022
// 1 - fetching a SPARQL JSON result and put it in a div
...
*/
fetch("https://gams.uni-graz.at/archive/objects/query:szd.fulltext/methods/sdef:Query/getJSON?params=%241|Angst%3B%242|de", 
		{method: 'get'})
